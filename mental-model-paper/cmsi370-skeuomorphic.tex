...
% Add an abstract.
\abstract{
This paper explains Bret Victor's thoughts and ideas on 'Learnable Programming.' His idea of a programming system having two parts, environment and language, is successfully aligned with the user and developer mental model.  This is important for anyone trying to learn how to successfully program. \cite{learnable-programming} }
...
\bibliography{cmsi370-learnableProgramming}
